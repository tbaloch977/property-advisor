...
if question:
    ...
    if responses:
        # GPT summary
        context = "\n\n".join([f"{t}\n{text}\nWatch here: {url}" for t, text, url in responses])
        prompt = f"You are a helpful UK property advisor. A user asked: '{question}'. Based on the clips below, write a friendly, informative answer. Then list 2–3 bullet points with the correct YouTube links.\n\n{context}"
